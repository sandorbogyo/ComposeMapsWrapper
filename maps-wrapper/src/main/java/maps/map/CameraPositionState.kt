...
import maps.wrapper.Projection
...
class CameraPositionState(
    ...
    // Guarded by `lock`.
    private var map: ExtendedMap? = null
                ...
                synchronized(lock) {
                    ...
                    if (map == null) {
                        ...
                        val animateOnMapAvailable = object : OnMapChangedCallback {
                            override fun onMapChangedLocked(newMap: ExtendedMap?) {
                                if (newMap == null) {
    ...
    private fun performAnimateCameraLocked(
        ...
        val cancelableCallback = object : ExtendedMap.CancelableCallback {
